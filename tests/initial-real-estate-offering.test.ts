...
import { handleAdminChanged } from "../src/initial-real-estate-offering";
import { createAdminChangedEvent } from "./initial-real-estate-offering-utils";
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    let previousAdmin = Address.fromString("0x0000000000000000000000000000000000000001");
